...
public class Solutions {
    public static void main(String[] args) {
        ...
        // Calculate TopRight
        for (int s = 1; s < n; s++) {
            if (!obstacles.contains(new Coords(rQueen + s, cQueen + s)) && rQueen + s <= n && cQueen + s <= n) {
                available++;
            } else {
                break;
            }
        ...
        // Calculate TopLeft
        for (int s = 1; s < n; s++) {
            if (!obstacles.contains(new Coords(rQueen + s, cQueen - s)) && rQueen + s <= n && cQueen - s >= 1) {
                available++;
            } else {
                break;
            }
        ...
        for (int s = 1; s < n; s++) {
            if (!obstacles.contains(new Coords(rQueen - s, cQueen + s)) && rQueen - s >= 1 && cQueen + s <= n) {
                available++;
            } else {
                break;
            }
        ...
        for (int s = 1; s < n; s++) {
            if (!obstacles.contains(new Coords(rQueen - s, cQueen - s)) && rQueen - s >= 1 && cQueen - s >= 1) {
                available++;
            } else {
                break;
            }
